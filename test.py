...
<body class="bg-slate-50 text-slate-800 font-sans antialiased">
                    ...
                    <div id="tab-moneter" class="tab-content active">
                        <div class="flex flex-col md:flex-row gap-8 items-center">
                            ...
                            <div class="w-full md:w-2/3">
                                ...
                                <ul class="space-y-2">
                                    <li class="flex items-start gap-2"><span class="text-green-500 font-bold">✓</span> <span class="text-sm text-slate-700"><strong>Analis Ekonomi:</strong> Menyusun asesmen ekonomi makro untuk Rapat Dewan Gubernur (RDG).</span></li>
                                    <li class="flex items-start gap-2"><span class="text-green-500 font-bold">✓</span> <span class="text-sm text-slate-700"><strong>Riset Kebijakan:</strong> Membangun model ekonometrika untuk memproyeksi dampak suku bunga (BI-Rate).</span></li>
                                    <li class="flex items-start gap-2"><span class="text-green-500 font-bold">✓</span> <span class="text-sm text-slate-700"><strong>Pengelolaan Devisa:</strong> Melakukan analisis pasar keuangan global dan intervensi pasar valas.</span></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex flex-col md:flex-row gap-8 items-center">
                            ...
                            <div class="w-full md:w-2/3">
                                ...
                                <ul class="space-y-2">
                                    ...
                                    <li class="flex items-start gap-2"><span class="text-green-500 font-bold">✓</span> <span class="text-sm text-slate-700"><strong>Pengawasan Penyelenggara Jasa Pembayaran (PJP):</strong> Mengaudit fintech, e-wallet, dan bank agar mematuhi standar keamanan BI.</span></li>
                                    <li class="flex items-start gap-2"><span class="text-green-500 font-bold">✓</span> <span class="text-sm text-slate-700"><strong>Pengelolaan Uang Rupiah:</strong> Merencanakan pencetakan, distribusi, hingga pemusnahan uang fisik di seluruh pelosok negeri.</span></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex flex-col md:flex-row gap-8 items-center">
                            ...
                            <div class="w-full md:w-2/3">
                                ...
                                <ul class="space-y-2">
                                    ...
                                    <li class="flex items-start gap-2"><span class="text-green-500 font-bold">✓</span> <span class="text-sm text-slate-700"><strong>Kebijakan Makroprudensial:</strong> Mengatur regulasi seperti rasio LTV (Loan to Value) untuk KPR, guna mencegah bubble properti.</span></li>
                                    <li class="flex items-start gap-2"><span class="text-green-500 font-bold">✓</span> <span class="text-sm text-slate-700"><strong>Kerjasama Internasional:</strong> Mewakili BI dalam forum seperti G20 atau IMF terkait stabilitas global.</span></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex flex-col md:flex-row gap-8 items-center">
                            ...
                            <div class="w-full md:w-2/3">
                                ...
                                <ul class="space-y-2">
                                    ...
                                    <li class="flex items-start gap-2"><span class="text-green-500 font-bold">✓</span> <span class="text-sm text-slate-700"><strong>Departemen Hukum:</strong> Merancang rancangan Peraturan Bank Indonesia (PBI) dan menangani litigasi.</span></li>
                                    <li class="flex items-start gap-2"><span class="text-green-500 font-bold">✓</span> <span class="text-sm text-slate-700"><strong>SDM & Strategi Manajemen:</strong> Mengembangkan talenta bank sentral dan mengelola transformasi kelembagaan.</span></li>
                                </ul>
                            </div>
                        </div>
                    </div>
    ...
    <footer class="bg-slate-900 text-slate-400 py-8 text-center mt-12">
        <p class="text-sm">© 2026 PCPM Insight Dashboard. Data disimulasikan berdasarkan tren profil profesional publik (seperti LinkedIn) untuk tujuan edukasi. Tidak terafiliasi dengan institusi resmi.</p>
    </footer>
